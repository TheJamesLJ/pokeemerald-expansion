...
const u32 gItemIcon_PokeVoucher[] = INCBIN_U32("graphics/items/icons/poke_voucher.4bpp.lz");
const u32 gItemIconPalette_PokeVoucher[] = INCBIN_U32("graphics/items/icon_palettes/poke_voucher.gbapal.lz");
