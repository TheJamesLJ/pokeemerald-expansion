...
#if RANDOMIZER_FIELD_ITEMS == TRUE
...
u16 RandomizeMon(enum RandomizerReason reason, enum RandomizerSpeciesMode mode, u32 seed, u16 species)
{
    ...
    DebugPrintfLevel(MGBA_LOG_DEBUG, "RandomizeMonFromSeed Species: " + resultSpecies + " : " + gSpeciesInfo[resultSpecies].speciesName);
